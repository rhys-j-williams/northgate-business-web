# Application security standard — Northgate Business

Owner: @northgate/business-digital. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@northgate.internal`) with the component name `business-web` and, if the finding came
