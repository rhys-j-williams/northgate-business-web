# Contributing to Northgate Business

Owning team: @northgate/business-digital. Ask in `#business-digital` on the internal chat platform before starting anything that
...
Feature branches are `feature/MBZ-1234-short-description`. Also permitted: `bugfix/`, `hotfix/`,
`spike/`, `chore/`. The pre-commit hook rejects anything else.

## Commits

`MBZ-1234 imperative summary`, 72 characters or fewer, with an optional body explaining why. The
